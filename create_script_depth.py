#!/usr/bin/env python
"""
Create a cluster job file to create a depth-of-coverage track.
"""
...
usage: create_script_depth [options] > depth.sh
...
def main():
	...
	if (trackName == None):
		trackName = "{base}/tracks/{run}.depth"
